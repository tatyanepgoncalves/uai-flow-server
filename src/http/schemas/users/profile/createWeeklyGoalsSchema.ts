...
export const createWeeklyGoalsSchema = {
  tags: ['Metas semanais'],
  summary: 'Cria metas de semanais do perfil do usuário autenticado.',
  description:
    'Endpoint para criar as metas de semanais do perfil do usuário autenticado.',
  body: z.object({
...
export type CreateWeeklyGoalsSchema = z.infer<
  typeof createWeeklyGoalsSchema.body
>
